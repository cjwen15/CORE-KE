...
import numpy as np
from crf_layer_mask import crf_layer



class BLSTM_CRF(object):
    def __init__(self, embedded_chars, hidden_unit, cell_type, num_layers, droupout_rate,
                 initializers, num_labels, seq_length, labels, lengths, is_training, label2idx_map):
        """
        BLSTM-CRF 网络
    ...
    def add_blstm_crf_layer(self):
        ...
        # crf
        loss, trans = crf_layer.decode(self=self, logits=logits, label_ids=self.labels, lengths=self.lengths)
